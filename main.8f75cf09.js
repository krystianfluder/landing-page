...
},{"_css_loader":"../../node_modules/parcel/src/builtins/css-loader.js"}],"../../node_modules/gsap/gsap-core.js":[function(require,module,exports) {
"use strict";
...
exports.showLayer = exports.hideLayer = exports.animateHero = void 0;
...
var showLayer = function showLayer() {
  ...
  _gsap.gsap.set(layer, {
    zIndex: 1
  });

  _toConsumableArray(layer.children).forEach(function (item) {
...
var animateHero = function animateHero(tl) {
  ...
  _gsap.gsap.set([heroActions.children, heroImage], {
    y: "20px",
    x: "20px",
    opacity: 0
  });

  _gsap.gsap.set(heroText.children, {
    x: "20px",
    opacity: 0
  });
...
},{"gsap":"../../node_modules/gsap/index.js"}],"../../node_modules/@stripe/stripe-js/dist/stripe.esm.js":[function(require,module,exports) {
"use strict";
...
var PRICE_ID = "price_1HLT8gEO4ScGYrFLO8hQoshC";
exports.PRICE_ID = PRICE_ID;
},{}],"../js/payments.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.buyNowListener = void 0;

var _stripeJs = require("@stripe/stripe-js");

var _env = require("../env");

var buyNowListener = function buyNowListener() {
  var heroBuyButton = document.getElementById("hero-buy");
  heroBuyButton.addEventListener("click", function () {
    (0, _stripeJs.loadStripe)(_env.STRIPE_PUBLISHABLE_KEY).then(function (stripe) {
      stripe.redirectToCheckout({
        ...
        mode: "payment",
        successUrl: "".concat(_env.BASE_URL, "/success.html"),
        cancelUrl: "".concat(_env.BASE_URL, "/cancel.html")
      }).catch(function (err) {
...
exports.buyNowListener = buyNowListener;
},{"@stripe/stripe-js":"../../node_modules/@stripe/stripe-js/dist/stripe.esm.js","../env":"../env.js"}],"../js/listeners.js":[function(require,module,exports) {
"use strict";
...
var initListeners = function initListeners() {
  ...
  layer.addEventListener("click", function () {
    (0, _animations.hideLayer)();
  });
  var heroReadmoreButton = document.getElementById("hero-readmore");
  heroReadmoreButton.addEventListener("click", function () {
    document.querySelector("#benefits").scrollIntoView({
      behavior: "smooth"
    });
  });
  var navigationOpenButton = document.querySelector("#navigation-open");
  navigationOpenButton.addEventListener("click", function () {
    (0, _animations.showLayer)();
  });
  (0, _payments.buyNowListener)();
};

exports.initListeners = initListeners;
},{"./payments":"../js/payments.js","./animations":"../js/animations.js"}],"../js/main.js":[function(require,module,exports) {
"use strict";
...
(0, _listeners.initListeners)(); // init animation

var tl = (0, _animations.hideLayer)();
(0, _animations.animateHero)(tl);
},{"../scss/main.scss":"../scss/main.scss","./animations":"../js/animations.js","./listeners":"../js/listeners.js"}],"../../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
